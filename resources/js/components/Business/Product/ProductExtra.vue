          ...
          >
            <div class="col-md-4 col-sm-4">
              <div class="form-group mb-4">
                ...
                <v-app :id="'variantbox' + index">
                  <v-combobox
                    :attach="'#variantbox' + index"
                    chips
                    hide-selected
            ...
            <div class="col-md-8 col-sm-8">
              <div class="form-group mb-4">
                ...
                <v-app :id="'variantOption' + index">
                  <v-combobox
                    :attach="'#variantOption' + index"
                    hide-selected
...
export default {
    ...
    if (this.allVariants) {
      ...
      this.allVariantsList = Object.keys(this.allVariantsList).map((key) => {
        return {
          ...
          options:
            this.allVariantsList[key].options !== '' ||
            this.allVariantsList[key].options !== undefined
              ? Object.keys(this.allVariantsList[key].options).map(
  ...
  methods: {
    ...
    addOptionsToList() {
      let allSelectedOptions = Object.keys(this.variantsListObj).map((key) => {
