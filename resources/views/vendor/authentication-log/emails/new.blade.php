                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                ...
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        ...
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0; text-align: center;">We notice a new sign-in with your Yabee Account.</p>
                                        <p style="font-size: 14px; color: #21B6A8FF; font-weight: 400; margin: 0 0 22px 0;text-align: center;">{!! $account->email !!}</p>

                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;text-align: center;text-align: center;">Device</p>
                                        <p style="text-align: center;">{!! $browser !!}</p>

                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;text-align: center;">Location</p>
                                        <p style="text-align: center;">{!! \Stevebauman\Location\Facades\Location::get($ipAddress) !!}</p>
                                        <p style="text-align: center;">{!! $ipAddress !!}</p>
                                        <p style="text-align: center;">(may not match your exact location)</p>

                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;text-align: center;">Time</p>
                                        <p style="text-align: center;">{!! $time->toCookieString() !!}</p>

                                        <p style="font-size: 14px; color: #7d8996; font-weight: 400; margin: 0 0 22px 0;text-align: center;">If you singed-in recently, relax and enjoy! But if you don't recognize the sign-in, we recommend that you change your password immediately to secure your account.</p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
