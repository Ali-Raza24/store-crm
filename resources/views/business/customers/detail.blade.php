...
@section('header_heading', "Customer Detail")
        ...
        <div class="row align-items-center">
            ...
            <div class="col-6 pl-0">
                <div class="text-right">
                    <a href="{{route('customers-edit',['id' => $customer->id])}}" class="btn-primary btn-rounded btn-size">Edit</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-4 col-sm-12 text-center">
                <div class="customer-img-panel">
                    <span><img src="{{asset('business_assets/images/customer-img.png')}}" alt="image"></span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        <div class="customer-detail-panel">
                            ...
                            <div class="form-group mt-1">
                                <p>{!! \App\Helpers\CommonHelper::countries()[$customer->country_id] !!}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="customer-detail-panel">
                            ...
                            <div class="form-group mt-1">
                                <p>{!! \App\Helpers\CommonHelper::states()[$customer->city_id] !!}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
