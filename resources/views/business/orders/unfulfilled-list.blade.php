...
@section('content')
    ...
    <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade @if(request()->routeIs('unfulfillment-orders-list')) show active @endif" id="Unfulfilled" role="tabpanel" aria-labelledby="Unfulfilled">
...
@section('scripts')
    ...
    <script>
        ...
        // order payment status change
        function orderPaymentStatusChangeUnpaid(order_id, status_id) {
            $('.dropdown-toggle').dropdown('hide');
            if (order_id != '' && status_id != '') {
                $.ajax({
                    url: '{{ route("change-status-orders") }}',
        ...
        // order  status change
        function orderFulfillmentStatusChangeUnpaid(order_id, status_id) {
            $('.dropdown-toggle').dropdown('hide');
            if (order_id != '' && status_id != '') {
                $.ajax({
                    url: '{{ route("change-fulfillment-status-orders") }}',
