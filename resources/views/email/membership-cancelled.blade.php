                                ...
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        ...
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">
                                            We're Sorry to Say you Goodbye
                                        </h4>
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">
                                            Hi, {!! $user->name !!}
                                        </h4>

                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">As you requested, we've cancelled your membership effective {!! $membership_cancel_date !!}</p>
                                        <div style="width: 100%;">
