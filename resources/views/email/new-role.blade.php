                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                ...
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        ...
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">New role added to your Yabee Account</h4>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">A new role {{$role->name}} has been successfully added to your Yabee Account {{$business->name}}. This role access level determines what features they can view and edit.</p>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">You can check the details of role from here <a href="{{$url}}" style="display: inline-block; background: #21B6A8; color: #1d262f; border-radius: 5px; font-size: 14px; font-weight: 700 !important; line-height: 40px; height: 40px; width: 100%; text-align: center;">View Details</a></p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
