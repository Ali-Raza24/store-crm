                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                ...
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        ...
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">Use this code to to verify email token</p>
                                        <h2 style="color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">{{$code}}</h2>
                                        <div style="width: 100%;">
                                        ...
                                        <p style="word-break: break-word;">Please do not share this OTP with anyone. If you did not make this request, just ignore the email. Otherwise, Please click the button above to reset your password</p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
