                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                ...
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        style="">
                                        <h4 style="color: #140A30; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">We Are Sad to See you Go</h4>
                                        <p style="font-size: 14px; color: #140A30; font-weight: 400; margin: 0 0 22px 0;">You've cancelled your Yabee Premium subscription which will end on 15/04/21.</p>
                                        <p style="font-size: 14px; color: #140A30; font-weight: 400; margin: 0 0 22px 0;">When your subscription ends, you will start</p>
                                        <p style="font-size: 14px; color: #140A30; font-weight: 400; margin: 0 0 22px 0;">If you want to come back, Yabee Premium is just a click away.</p>
                                        <div style="width: 100%;">
                                            <div style="text-align: center;">
                                                <a href="{{$url}}"
                                                   style="display: inline-block; background: #21B6A8; color: #140A30; border-radius: 5px; font-size: 14px; font-weight: 700 !important; line-height: 40px; height: 40px; width: 100%; text-align: center;">
                                                    Get Yabee Premium
                                                </a>
                                            </div>
                                        </div>

                                        <p style="font-size: 14px; color: #140A30; font-weight: 400; margin: 0 0 22px 0;">We hope to welcome you back soon.</p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top"
                                                                ...
                                                                <h4
                                                                        style="color: #140A30; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center;">
                                                                    Need help?
                                                                </h4>
                                                                <p
