                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                ...
                                <tr>
                                    <td align="center" valign="top"
                                        ...
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: left;">
                                            Hi {{$order->customer->name}}
                                        </h4>
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: left;">
                                            Refund Notification
                                        </h4>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0; text-align: left;">
                                            Your refund has been successfully processed. Depending on the payment method, It may take a few business days to appear.
                                        </p>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0; text-align: left;">
                                            Please do not hesitate to contact us or reply to this email if you have any questions.
                                        </p>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0; text-align: left;">
                                            Many Thanks
                                        </p>
                                    ...
                                    <td align="center" valign="top"
                                        ...
                                        <table width="100%" cellspacing="0" cellpadding="0" border="0"
                                            ...
                                            <tr>
                                                <td>
                                                    <p
                                                            style="color: #1d262f; line-height: 124.95%; font-size: 14px; font-weight: 500 !important; text-align: left; margin: 0 0 15px 0;">
                                                        Order details
                                                    </p>
                                                </td>
                                                <td align="right">
                                                    <p
                                                            style="color: #1d262f; line-height: 124.95%; font-size: 14px; font-weight: 600 !important; margin: 0 0 15px 0; text-align: right;">
                                            ...
                                            <tr style="width: 100%;">
                                                <td style="width: 100%;">
                                                    <div
                                                            style="height: 2px; width: 100%; background: #1d262f;">
                                                        &nbsp; </div>
                                                </td>
                                                <td style="width: 100%;">
                                                    <div
