                                ...
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        ...
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">
                                            Delete Store Verification
                                        </h4>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">Please confirm the deletion of your store at Yabee.</p>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">All Orders that you have created will be permanently erased. You may want to save backups of all orders export them before deletion.</p>
                                        <div style="width: 100%;">
                                        ...
                                        <p style="font-size: 14px; color: #ff0000; font-weight: 400; margin: 0 0 22px 0;">This cannot be undone. Please make sure your are deleting the correct profile.</p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
