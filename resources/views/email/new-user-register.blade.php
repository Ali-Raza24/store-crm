                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                ...
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        ...
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">
                                            Invitation to Access Yabee Portal
                                        </h4>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">{{$business->name}} has invited you to access
                                            yabee Account.</p>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">Keep in mind the access level you’re granted determines what features you can view or edit.</p>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">Simply go here
                                            {{$login_url}} to get started,
                                            or our support team can be reached at {{$business->email}} and WhatsApp
                                            {{$business->mobile}} to learn more about the new features you have acquired.</p>
