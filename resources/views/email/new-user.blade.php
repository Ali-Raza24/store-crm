                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                ...
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        style="">
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">Hi {{$business->name}}</h4>
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">New User added to your Yabee Account</h4>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">A new user {{$user->email}} has been successfully added to your Yabee Account {{$business->name}}. This user access level determines what features they can view and edit.</p>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">If you don’t recognize this user, you can remove the user here <a href="{{$url}}" style="display: inline-block; background: #21B6A8; color: #1d262f; border-radius: 5px; font-size: 14px; font-weight: 700 !important; line-height: 40px; height: 40px; width: 100%; text-align: center;">View Details</a></p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
