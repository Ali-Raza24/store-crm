                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                ...
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        ...
                                        <p style="font-size: 14px; color: #140A30; font-weight: 400; margin: 0 0 22px 0;">Hi {!! $user->name !!},</p>
                                        <p style="">Don't worry. We'll try your payment again over the next few days. </p>
                                        <div style="width: 100%;">
                                        ...
                                        <p style="font-size: 14px; color: #140A30; font-weight: 400; margin: 0 0 22px 0;">If that doesn't work copy and paste the following link to your browser.</p>
                                        <p style="font-size: 14px; color: #21B6A8FF; font-weight: 400; margin: 0 0 22px 0;">{!! $url !!}</p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
