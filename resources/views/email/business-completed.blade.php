                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                ...
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        style="">
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">You Just Started A Business. Congrats !</h4>
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">Welcome to {{config('app.name')}} !</h4>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">Starting an online business was not easy before {{config('app.name')}}. We will handle everything from creating an online store , secure checkout and shipping. So you can focus on your sales.</p>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">Here’s where you can find the {{$business->name}} online</p>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">{{config('urls.store_url')}}/{{$business->url}}</p>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">Simply go here
                                            {{route('login')}} to get started, or our support team can be reached at
                                            {{config('app.admin_email')}} and WhatsApp +971502567251 to learn more about how to create your online store.</p>
                                        <p style="font-size: 14px; color: #21B6A8FF; font-weight: 400; margin: 0 0 22px 0;">Have a great day !</p>
                                        <p style="font-size: 14px; color: #21B6A8FF; font-weight: 400; margin: 0 0 22px 0;">Regards.</p>
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">Admin</h4>
