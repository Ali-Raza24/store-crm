        ...
        <tr>
            <td align="center" valign="top" id="bodyCell">
                <table bgcolor="#f2f2f2" border="0" cellpadding="0" cellspacing="0" width="600" id="emailBody"
                    ...
                    <tr>
                        <td valign="top" align="center" style="text-align: center; padding: 0 60px; ">
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                <tbody>
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        style="">
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">Hi {{$user->name}}</h4>
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">Order Confirmation</h4>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">Thank you for your purchase!</p>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">Just letting you know that your order has been confirmed and is being prepared for you. We will send you another email as soon as your order has been shipped out.</p>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">You can follow the status of your order by clicking the button below:</p>
                                        <div style="width: 100%;"><div style="text-align: center;"><a href="{{$url}}" style="display: inline-block; background: #21B6A8; color: #1d262f; border-radius: 5px; font-size: 14px; font-weight: 700 !important; line-height: 40px; height: 40px; width: 100%; text-align: center;">Track Order</a></div></div>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">Please do not hesitate to contact us or reply to this email if you have any questions.</p>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">Many thanks,</p>
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">{{$business->name}}</h4>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
