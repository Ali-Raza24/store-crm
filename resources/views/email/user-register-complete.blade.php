                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                ...
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        ...
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">Your registration is completed</p>
                                        <p style="font-size: 14px; color: #21B6A8FF; font-weight: 400; margin: 0 0 22px 0;">
                                            {!! $user->email !!}</p>
                                    </td>
                                </tr>
                                </tbody>
