                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                ...
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        style="">
                                        <h4 style="color: #140A30; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">
                                            Payment Successfully
                                        </h4>
                                        <h4 style="color: #140A30; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">
                                            Hi {!! $user->name !!}
                                        </h4>
                                        <p style="font-size: 14px; color: #140A30; font-weight: 400; margin: 0 0 22px 0;">Thank you for your transaction {!! $user->name !!}. We have received your payment of AED {!! $amount !!}</p>
                                        <p style="font-size: 14px; color: #140A30; font-weight: 400; margin: 0 0 22px 0;">We have sent you an email all the details of your transaction. You'll be notified via emails about status of your transaction.</p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
