                                ...
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        ...
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">
                                            OOGO PAY Integration
                                        </h4>
                                        <h4 style="color: #1d262f; line-height: 124.95%; font-size: 18px; font-weight: bold; text-align: center">
                                            Hi {!! $buiness->name !!}
                                        </h4>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">Payment method Yabee PAY was recently active to your account. </p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
