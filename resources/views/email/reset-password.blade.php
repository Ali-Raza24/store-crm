                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                ...
                                <tr style="text-align: center">
                                    <td align="center" valign="top"
                                        ...
                                        <p
                                                style="font-size: 14px; color: #140A30; font-weight: 400; margin: 0 0 22px 0;">
                                            There's a request to reset your password!.</p>
                                        <div style="width: 100%;">
                                        ...
                                        <p style="word-break: break-word;">If you did not make this request, just ignore the email. Otherwise, Please click the button above to reset your password</p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
