...
<center style="background-color:#ffffff;">
    ...
    Welcome to Yabee
                                        ...
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">We're excited to have to get started. First, you need to confirm your account. Just click the following button.</p>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">We're excited to have you get started. First, you need to confirm your account. Just click the following button.</p>
                                        <div style="width: 100%;">
                                            <div style="text-align: center;">
                                                <a href="{{$url}}"
                                                   style="display: inline-block; background: #25e390; color: #1d262f; border-radius: 5px; font-size: 14px; font-weight: 700 !important; line-height: 40px; height: 40px; width: 100%; text-align: center;">
                                                       Confirm Account
</a>
                                            </div>
                                        </div>
                                        <p style="font-size: 14px; color: #1d262f; font-weight: 400; margin: 0 0 22px 0;">
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top"
                                                                ...
                                                                <a href="#."
                                                                   style="display: block; font-size: 12px; color: #25e390; font-weight: 500; margin: 0 0 0 0; text-align: center;">info@yabee.me</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
