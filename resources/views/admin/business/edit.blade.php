...
@section('content')
    ...
    {!! Form::open(['url' => route('admin-business-update'), 'files' => true]) !!}
    {{method_field('PUT')}}
        ...
        <div class="row align-items-center">
            ...
            <div class="col-6 pl-0">
                <div class="text-right">
                    <button class="btn-size btn-rounded btn-primary">
                        Update
                    </button>
                </div>
            </div>
                    ...
                    <div class="basic-customer">
                        <span>
                            @if(!empty($business->logo))
                                <image-upload name="images[logo]" image_placeholder="{{$business->logo}}"></image-upload>
                            @else
                                <image-upload name="images[logo]" image_placeholder="{{asset('img/camera_icon.png')}}"></image-upload>
                            @endif
                        </span>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="customer-detail-panel">
                            ...
                            <div class="form-group mt-1">
                                <input name="owner_name" type="text" value="{{$business->owner_name}}"
                                        class="order-edit-control form-control @if($errors->has('owner_name')) border-danger @endif"
                                />
                                @error('owner_name')
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="customer-detail-panel">
                            ...
                            <div class="form-group mt-1">
                                <input name="owner_email" type="text" value="{{$business->owner_email}}" readonly
                                       class="order-edit-control form-control @if($errors->has('owner_email')) border-danger @endif"
                                />
                                @error('owner_email')
                                <div class="input-info danger-bg">
                                    {{ $message }}
                        ...
                        <div class="customer-detail-panel">
                            ...
                            <div class="form-group mt-1">
                                <input
                                        name="owner_mobile"
                                        type="text"
                                        value="{{$business->owner_mobile}}"
                                        class="order-edit-control form-control @if($errors->has('owner_mobile')) border-danger @endif"
                                />
                                @error('owner_mobile')
                                <div class="input-info danger-bg">
                                    {{ $message }}
                        ...
                        <div class="customer-detail-panel">
                            ...
                            <div class="form-group mt-1">
                                <input
                                        ...
                                        readonly
                                        value="{{$business->name}}"
                                        class="order-edit-control form-control @if($errors->has('name')) border-danger @endif"
                                />
                                @error('name')
                                <div class="input-info danger-bg">
                                    {{ $message }}
...
{{--                                        readonly--}}
                                        ...
                                        class="order-edit-control form-control @if($errors->has('email')) border-danger @endif"
                                />
                                @error('email')
                                <div class="input-info danger-bg">
                                    {{ $message }}
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        <div class="customer-detail-panel">
                            ...
                            <div class="form-group mt-1">
                                <input
                                        type="text"
                                        class="order-edit-control form-control @if($errors->has('mobile')) border-danger @endif"
                                        name="mobile"
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="customer-detail-panel">
                            ...
                            <div class="form-group mt-1">
                                <input type="color" class="order-edit-control form-control"
                                       value="{{$business->brand_color}}" name="brand_color"
                                />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6 col-sm-6">
                        <div class="customer-detail-panel">
                            ...
                            <div class="form-group mt-1">
                                {!! Form::select('business_type_id', $businessTypes, $business->business_type_id, ['class' => 'form-control order-edit-control']) !!}
                            </div>
                        </div>
                    </div>
                    {{--<div class="col-md-12">
            ...
            <div class="col-filter">
                <nav class="tabs-head mobile-hide" id="allOrders">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a
                                class="nav-item nav-link @if(request()->routeIs('admin-business-staff') || request()->routeIs('admin-business-edit')) active @endif"
                                id="Staff-Accounts-tab"
                                href="{{route('admin-business-staff', $business->id)}}"
                                role="tab"
                                aria-selected="true"
                        >Staff Accounts</a
                        >
                        <a
                                class="nav-item nav-link @if(request()->routeIs('admin-business-transactions')) active @endif"
                                id="Transaction-History-tab"
                                href="{{route('admin-business-transactions', $business->id)}}"
                                role="tab"
                                aria-selected="true"
                ...
                <div class="dropdown tabs-dropdown desktop-hide">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropTab">
                        <a class="nav-item nav-link active" href="{{route('admin-business-staff', $business->id)}}"
                        >Staff Accounts</a
                        >
                        <a class="nav-item nav-link" href="{{route('admin-business-transactions', $business->id)}}"
                        >Transaction History</a
                        >
                    </div>
                </div>
    ...
    <div class="tab-content" id="nav-tabContent">
        @if(request()->routeIs('admin-business-staff') || request()->routeIs('admin-business-edit'))
        <div
