                    ...
                    <div class="tab-pane fade @if(empty($showUpdateRoletab)) active show @endif" id="Users"
                        ...
                        <div class="pro-table-seting">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a class="btn-size btn-rounded btn-primary" href="{{ route('admin-user-add') }}"
                                               ...
                                               @if(!empty($user))
                                                ...
                                                <td>
                                                    <div class="table-action">
                                                        ...
                                                        @endif
                                                        <div class="modal fade refund-modal" id="cancelRefund-{{ $user->id }}" tabindex="-1" role="dialog" aria-modal="true" style="padding-right: 17px;">
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-body">
                                                                        <h4 class="dark-two mb-3">Are you sure to delete this user?</h4>
                                                                        <h2 class="font-weight-700 dark-one mb-2">Are You Sure?</h2>
                                                                        <form method="POST" action='{{route('admin-user-delete', ['id' => $user->id])}}' id='deleteuserForm' class='d-none'>
                                                                            @csrf
                                                                            {{method_field('DELETE')}}
                                                                        </form>
                                                                        <a href="javascript:void(0)" class="btn-size btn-rounded btn-primary ml-1 mr-1" onclick="deleteUser()">Ok </a>
