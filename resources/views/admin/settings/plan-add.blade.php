            ...
            <div class="card-repeat setting-general pb-3 mt-4">
                <nav class="tabs-head mobile-hide" id="allOrders">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        {{--                        <a class="nav-item nav-link" id="Basic-plan-tab" data-toggle="tab" href="#Basic-plan" role="tab" aria-controls="Basic-plan" aria-selected="false">--}}
                        {{--                            Basic--}}
                        {{--                        </a>--}}
                        {{--                        <a class="nav-item nav-link" id="Advanced-plan-tab" data-toggle="tab" href="#Advanced-plan" role="tab" aria-controls="Advanced-plan" aria-selected="false">--}}
                        {{--                            Advanced--}}
                        {{--                        </a>--}}
                    </div>
                </nav>
                        ...
                        <form method='post' action='{{route('admin-plans-store')}}' id='plan-form'>
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group mb-3">
                                    ...
                                    <input name='plan_title' value="{{ old('plan_title') }}" type="text" placeholder=""
                                ...
                                <div class="col-sm-6 form-group mb-3">
                                    ...
                                    <input name='plan_monthly_price' value="{{ old('plan_monthly_price') }}" type="text"
                                           placeholder=""
                                ...
                                <div class="col-sm-6 form-group mb-3">
                                    ...
                                    <input name='plan_yearly_price' value="{{ old('plan_yearly_price') }}" type="text"
                                           placeholder=""
                                ...
                                <div class="col-sm-12 form-group mb-3">
                                    ...
                                    <textarea name='plan_desc'
                                              class="form-control order-edit-control @error('plan_desc') danger-border @enderror">{{ old('plan_desc') }}</textarea>
                                    @error('plan_desc')
                                    <div class="input-info danger-bg">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mt-5">
                                <div class="col-lg-12">
                                    <div class="form-group mb-4">
                                        <div class="table-responsive scroll-bar-thin location-group sm-radius-control" style="max-height: 500px">
                            ...
                            <div class="form-group mb-0 text-right">
                                <hr class="mt-5 mb-3" />
                                <button class="btn-size btn-rounded btn-primary mr-3">Add</button>
        ...
        @section('custom_script')
            <script>
              ...
              function addMoreOptions (id) {
                ...
                let $existing = $allOptions.some(alloption => {
                  return alloption.planOption === $planOption;
                })
