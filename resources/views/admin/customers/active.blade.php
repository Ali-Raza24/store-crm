...
@section('content')
			...
			<div class="col-filter">
				<nav class="tabs-head mobile-hide" id="allOrders">
					<div class="nav nav-tabs" id="nav-tab" role="tablist">
						<a class="nav-item nav-link @if(request()->routeIs('admin-customers-list')) active @endif" id="AllCustomer-tab"  href="{{route('admin-customers-list')}}" href aria-controls="AllCustomer" aria-selected="true">
							All Customers
						</a>
						<a class="nav-item nav-link @if(request()->routeIs('admin-customers-active-list')) show active @endif" id="ActCustomer-tab"  href="{{route('admin-customers-active-list')}}"  aria-controls="ActCustomer" aria-selected="false">
							Active
						</a>
	...
	<div class="tab-content" id="nav-tabContent">
		...
		<div class="tab-pane fade @if(request()->routeIs('admin-customers-active-list')) show active @endif" id="ActCustomer" role="tabpanel" aria-labelledby="ActCustomer">
            @include('admin.customers.partials.table')
        </div>
		<div class="tab-pane fade" id="SuspActCustomer" role="tabpanel" aria-labelledby="SuspActCustomer">
        </div>
	</div>
@endsection
