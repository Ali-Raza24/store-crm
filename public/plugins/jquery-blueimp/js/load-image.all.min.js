!(function(c) {
  ...
  function m(s, e, l) {
    function t(i, a) {
      ...
      function e(e, t) {
        t && c.console && console.log(t),
          e && g('Blob', e)
            ? (n = f((s = e)))
            : ((n = s), l && l.crossOrigin && (r.crossOrigin = l.crossOrigin)),
          (r.src = n);
      }
    ...
    return c.Promise && 'function' != typeof e
      ? ((l = e), new Promise(t))
      : t(e, e);
  }
      ...
      (E.drawImage = function(e, t, i, a, n, r, o, s, l) {
        ...
        return (
          !1 === l.imageSmoothingEnabled
            ? ((c.msImageSmoothingEnabled = !1), (c.imageSmoothingEnabled = !1))
            ...
            ? (g = s / l - (b = a) / (y = n)) < 0
              ...
              : 0 < g &&
                ...
                t.left === undefined &&
                  t.right === undefined &&
                  (c = (p - s) / 2))
            : ((t.contain || t.cover) && ((r = a = a || r), (o = n = n || o)),
              t.cover ? (v(), S()) : (S(), v())),
          h)
        ) {
          if (
            (1 < (u = t.pixelRatio) &&
              (!e.style.width ||
                Math.floor(parseFloat(e.style.width, 10)) !==
                  Math.floor(p / u)) &&
              ((b *= u), (y *= u)),
            E.orientationCropBug &&
              ...
              (c || f || s !== p || l !== A) &&
              ((g = e),
              (e = E.createCanvas(p, A, !0)),
              E.drawImage(g, e, 0, 0, p, A, p, A, t)),
            0 < (d = t.downsamplingRatio) && d < 1 && b < s && y < l)
          )
            for (; b < s * d; )
              (m = E.createCanvas(s * d, l * d, !0)),
                E.drawImage(e, m, c, f, s, l, m.width, m.height, t),
                (f = c = 0),
                (s = m.width),
                (l = m.height),
                (e = m);
          return (
            (m = E.createCanvas(b, y)),
            E.transformCoordinates(m, t, i),
            1 < u && (m.style.width = m.width / u + 'px'),
            E.drawImage(e, m, c, f, s, l, b, y, t).setTransform(
              1,
              0,
              0,
              1,
  ...
  (function(e) {
    ...
    function c(t, e, u, d) {
      ...
      function i(c, f) {
        if (!(s.DataView && a && t && 12 <= t.size && 'image/jpeg' === t.type))
          return c(d);
        ...
        o.readFile(
          ...
          function(e) {
            ...
            if (65496 !== t.getUint16(0))
              return f(new Error('Invalid JPEG file: Missing JPEG marker.'));
            for (
              var i, a, n, r, o = 2, s = t.byteLength - 4, l = o;
              o < s &&
              ((65504 <= (i = t.getUint16(o)) && i <= 65519) || 65534 === i);
              ...
              if ((n = h.jpeg[i]) && !u.disableMetaDataParsers)
                for (r = 0; r < n.length; r += 1) n[r].call(g, t, o, a, d, u);
              l = o += a;
            }
    ...
    function n(e, t, i) {
      return e && t && i
        ? new Blob([i, a.call(e, t.byteLength)], { type: 'image/jpeg' })
        : null;
    }
    ...
    (o.transform = function(t, i, a, n, r) {
      o.requiresMetaData(i)
        ? c(
            n,
            function(e) {
              e !== r && (s.console && console.log(e), (e = r)),
                l.call(o, t, i, a, n, e);
            },
            i,
            (r = r || {})
  ...
  (function(e) {
    ...
    r.fetch && r.Request && r.Response && r.Response.prototype.blob
      ? (e.fetchBlob = function(e, t, i) {
          ...
          if (r.Promise && 'function' != typeof t)
            return fetch(new Request(e, t)).then(a);
      ...
      : r.XMLHttpRequest &&
        ...
        (e.fetchBlob = function(e, t, n) {
          ...
          return r.Promise && 'function' != typeof t
            ? ((n = t), new Promise(i))
            : i(t, t);
        });
  }),
    ...
    (t = h).global.document &&
      (((i = document.createElement('img')).onload = function() {
        ...
        (t.orientation = 2 === i.width && 3 === i.height),
          t.orientation &&
            ((e = t.createCanvas(1, 1, !0).getContext('2d')).drawImage(
              i,
              1,
              1,
              1,
            ...
            (t.orientationCropBug =
              '255,255,255,255' !==
              e.getImageData(0, 0, 1, 1).data.toString()));
      }),
      (i.src =
      ...
      (h.transform = function(e, t, r, i, a) {
        n.call(
          ...
          function(e, t) {
            var i, a, n;
            !t ||
              (4 < (i = h.orientation && t.exif && t.exif.get('Orientation')) &&
                i < 9 &&
                ((a = t.originalWidth),
                (n = t.originalHeight),
                (t.originalWidth = n),
      ...
      (h.getTransformedOptions = function(e, t, i) {
        ...
        var s,
          ...
          g = {};
        for (var m in a)
          Object.prototype.hasOwnProperty.call(a, m) && (g[m] = a[m]);
        if (
          (((4 < (g.orientation = r) && !(4 < o)) || (r < 5 && 4 < o)) &&
            ((g.maxWidth = a.maxHeight),
            (g.maxHeight = a.maxWidth),
            (g.minWidth = a.minHeight),
            (g.minHeight = a.minWidth),
            (g.sourceWidth = a.sourceHeight),
            (g.sourceHeight = a.sourceWidth)),
          1 < o)
        ) {
          switch (o) {
            case 2:
  ...
  (function(e) {
    ...
    function h(e) {
      e &&
        (Object.defineProperty(this, 'map', { value: this.ifds[e].map }),
    ...
    (m[7] = m[1]),
          ...
          if (1165519206 === c.getUint32(e + 4))
            if (m + 8 > c.byteLength)
              ...
              42 === c.getUint16(m + 2, u)
                ? ((a = c.getUint32(m + 4, u)),
                  (f.exif = new h()),
                  i.disableExifOffsets ||
                    ((f.exifOffsets = new h()),
                    (f.exifTiffOffset = m),
                    (f.exifLittleEndian = u)),
                  (a = A(c, m, m + a, u, f.exif, f.exifOffsets, d, g)) &&
                    p(d, g, 'ifd1') &&
                    ((f.exif.ifd1 = a),
                    f.exifOffsets && (f.exifOffsets.ifd1 = m + a)),
                  Object.keys(f.exif.ifds).forEach(function(e) {
                    ...
                    (i = e),
                      ...
                      (l = (t = f).exif[i]) &&
                        ((t.exif[i] = new h(i)),
                        t.exifOffsets && (t.exifOffsets[i] = new h(i)),
                        A(
                          a,
                          n,
                          n + l,
                  ...
                  (n = f.exif.ifd1) &&
                    ...
                    (n[513] = (function(e, t, i) {
                      if (i) {
                        if (!(t + i > e.byteLength))
                          return new Blob(
                            [r.bufferSlice.call(e.buffer, t, t + i)],
                            { type: 'image/jpeg' }
                          );
                        console.log(
      ...
      (r.exifWriters = {
        274: function(e, t, i) {
          ...
          return (
            a && new DataView(e, a + 8, 2).setUint16(0, i, t.exifLittleEndian),
            e
          );
        }
      }),
      ...
      (n.getAll = function() {
        ...
        for (e in this)
          Object.prototype.hasOwnProperty.call(this, e) &&
            ((t = this[e]) && t.getAll
              ? (a[this.ifds[e].name] = t.getAll())
              : (i = this.tags[e]) && (a[i] = this.getText(i)));
        return a;
      }),
  ...
  (function(e) {
    ...
    function m(e, t, i, a, n) {
      return 'binary' === t.types[e]
        ...
        ? i.getUint16(a)
        : (function(e, t, i) {
            for (var a = '', n = t + i, r = t; r < n; r += 1)
              a += String.fromCharCode(e.getUint8(r));
            return a;
          })(i, a, n);
    }
          ...
          (n && !n[l]) ||
            ...
            (a.iptc[l] =
              ...
              c === undefined
                ...
                ? (c.push(f), c)
                : [c, f])),
            a.iptcOffsets && (a.iptcOffsets[l] = d))),
          (d += 1);
    }
      ...
      (e.parseIptcData = function(e, t, i, a, n) {
        if (!n.disableIptc)
          for (var r, o, s, l, c = t + i; t + 8 < c; ) {
            if (
              ((l = t),
              943868237 === (s = e).getUint32(l) && 1028 === s.getUint16(l + 4))
            ) {
              var f =
                  ((r = t),
                  (o = void 0),
                  (o = e.getUint8(r + 7)) % 2 != 0 && (o += 1),
                  0 === o && (o = 4),
                  o),
                u = t + 8 + f;
              if (c < u) {
              ...
              return (
                (a.iptc = new g()),
                n.disableIptcOffsets || (a.iptcOffsets = new g()),
                void h(
                  e,
                  u,
                  d,
    ...
    (a.tags = {
      ...
      (function() {
        var e,
          ...
          i = a.map || {};
        for (e in t)
          Object.prototype.hasOwnProperty.call(t, e) && (i[t[e]] = Number(e));
      })();
  });
