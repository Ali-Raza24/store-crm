...
use App\Http\Middleware\StoreRedirect;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'onlyJson' => OnlyJson::class,
        'auth.business' => BusinessAuth::class,
        'auth.admin' => AdminAuth::class,
        'auth.store' => StoreAuth::class,
        'auth.api' => ApiAuthenticate::class,
        'permission' => Permission::class,
        'user.subscribed' => EnsureUserIsSubscribed::class,
        'store.redirect' => StoreRedirect::class,
    ];
}
